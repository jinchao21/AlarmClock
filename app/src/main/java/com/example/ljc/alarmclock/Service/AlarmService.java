...
//                Log.d(TAG, "getReAlarm id = " + Integer.toString(id) + " " + Integer.toString(hour) + " " + Integer.toString(minutes) + " " + Integer.toString(daysofweek) + " " + Integer.toString(state));
